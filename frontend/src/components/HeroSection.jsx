        ...
        <>
            <section className="relative h-96 md:h-[24rem]">
                <div
                    ...
                    style={{
                        backgroundImage: `url('https://placehold.co/1280x600/d1d5db/4b2e83?text=School+Building')`,
                    }}
                    role="img"
            ...
            >
                ...
                ></div>
                <div
                    className={`relative bg-white p-6 md:p-8 rounded-2xl w-[90%] max-w-xl shadow-2xl transition-transform duration-400 ease-in-out ${isPopupOpen ? 'translate-y-0' : 'translate-y-full'}`}
                >
                    <button
                    ...
                    <div className="flex justify-center mb-4">
                        <img
                            src="https://placehold.co/150x150/d7dbe2/4b2e83?text=Logo"
                            alt="School Logo"
                    ...
                    <form className="space-y-4" onSubmit={handleFormSubmit}>
                        <div>
                            <label htmlFor="name" className="text-gray-700 font-semibold after:content-['*'] after:text-red-500 after:ml-1">
                                Name
                            </label>
                            <input
                                id="name"
                        ...
                        <div>
                            <label htmlFor="email" className="text-gray-700 font-semibold after:content-['*'] after:text-red-500 after:ml-1">
                                Email
                            </label>
                            <input
                                id="email"
                        ...
                        <div>
                            <label htmlFor="phone" className="text-gray-700 font-semibold after:content-['*'] after:text-red-500 after:ml-1">
                                Phone
                            </label>
                            <input
                                id="phone"
                        ...
                        <div>
                            <label htmlFor="address" className="text-gray-700 font-semibold after:content-['*'] after:text-red-500 after:ml-1">
                                Address
                            </label>
                            <textarea
                                id="address"

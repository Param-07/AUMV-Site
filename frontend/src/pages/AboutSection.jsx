...
const AboutSection = () => {
  ...
  const sections = [
    {
      ...
      image: "https://placehold.co/700x450/dae1f6/2f2f93?text=Front+View+of+School",
    ...
    },
    {
      ...
      image: "https://placehold.co/700x450/dae1f6/2f2f93?text=Principal+of+Alok+School",
    ...
    },
    {
      ...
      image: "https://placehold.co/700x450/dae1f6/2f2f93?text=Director+of+Alok+School",
    ...
    },
    {
      ...
      image: "https://placehold.co/700x450/dae1f6/2f2f93?text=Our+Vision+and+Mission",
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-gray-50 to-white py-16 md:py-24">
      ...
      <div className="absolute -top-20 left-10 w-40 h-40 bg-indigo-200/30 blur-3xl rounded-full"></div>
      <div className="absolute bottom-0 right-10 w-52 h-52 bg-purple-300/30 blur-3xl rounded-full"></div>
          ...
          >
            ...
            >
              <img
                src={section.image}
                alt={section.alt}
                className="w-full h-auto rounded-2xl shadow-[0_8px_25px_rgba(0,0,0,0.13)] transform hover:scale-[1.02] transition duration-500"
              />

              {/* Accent card behind image */}
              <div className="absolute inset-0 -z-10 translate-x-6 translate-y-6 bg-indigo-300/20 rounded-2xl"></div>
            </motion.div>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-3xl md:text-4xl font-bold text-indigo-800 mb-4 leading-snug">
                {section.title}
              </h2>
